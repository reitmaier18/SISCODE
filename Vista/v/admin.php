...
<body id="body">
                    ...
                    <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-333" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">REPORTES </a>
                        <div class="dropdown-menu dropdown-default" aria-labelledby="navbarDropdownMenuLink-333">
                            ...
                            <a class="dropdown-item" onclick="mostrar_mod_log_sistema();">Log del sistema</a>
                        </div>
                    </li>
                    ...
                    <div class="col-md-10" id="reporte_estadistico">
                        ...
                        <div id="reporte_solicitud">
                            ...
                            <div id="list_reporte_solicitud">
                                ...
                                <center><button class="btn btn-primary" onclick="imprimir_reporte_solicitud();">Imprimir PDF</button> <button class="btn btn-blue-grey" onclick="reiniciar_reporte_solicitud();">Regresar</button> <button class="btn btn-success" onclick="mostrar_grafica();">Graficas</button></center>
                                <br>
                            </div>
                        </div>
	...
	<!-- SCRIPTS -->
    <script type="text/javascript" src="js/efectos_admin.js"></script>    
    <!-- Bootstrap tooltips -->
