                                        ...
                                        <tr>
                                          <td colspan="100">
                                            <div class="text-right">
                                              <div class="input-append input-append">
                                                <div class="btn-group" role="group" aria-label="...">
                                                  <button class="btn btn-blue-grey btn-next" type="button" onclick=""></button>
                                                  <div class="btn-group" role="group">
                                                    <select name="p" id="act_" class="form-control" onchange="">
                                                       <option value="1">1</option>
                                                    </select>
                                                    </div>
                                                  <button class="btn btn-blue-grey btn-back" type="button" onclick=""></button>
                                                </div>
                                            </div>
                                        </td>
                                        </tr>
