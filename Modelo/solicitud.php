    ...
    class solicitud
    {
        ...
        */
    	function listar_solicitud_admin_int(){
    		$sql = ("select date(fecha) as fecha, extract(hour from fecha) as hora, extract(minute from fecha) as minuto, extract(second from fecha) as segundo,nombre, apellido, tipo, numero_expediente, numero_pieza, ubicacion, sisco.solicitud.estatus as estatus, sisco.solicitud.id from sisco.solicitud inner join sisco.usuario on sisco.solicitud.usuario_id = sisco.usuario.id inner join sisco.tipo_solicitud on sisco.solicitud.tipo_solicitud_id = sisco.tipo_solicitud.id inner join sisco.pieza on sisco.solicitud.pieza_id = sisco.pieza.id inner join sisco.expediente on sisco.pieza.expediente_id = sisco.expediente.id inner join sisco.ubicacion on sisco.solicitud.ubicacion_id = sisco.ubicacion.id where sisco.solicitud.estatus<>4 and sisco.solicitud.estatus<>3 and tipo='Interna' order by fecha DESC");
    		$query=pg_query($sql);
    	...
    	function listar_solicitud_admin_ext(){
    		$sql = ("select date(fecha) as fecha, extract(hour from fecha) as hora, extract(minute from fecha) as minuto, extract(second from fecha) as segundo,nombre, apellido, tipo, numero_expediente, numero_pieza, ubicacion, sisco.solicitud.estatus as estatus, sisco.solicitud.id from sisco.solicitud inner join sisco.solicitante_externo on sisco.solicitud.usuario_id = sisco.solicitante_externo.id inner join sisco.tipo_solicitud on sisco.solicitud.tipo_solicitud_id = sisco.tipo_solicitud.id inner join sisco.pieza on sisco.solicitud.pieza_id = sisco.pieza.id inner join sisco.expediente on sisco.pieza.expediente_id = sisco.expediente.id inner join sisco.ubicacion on sisco.solicitud.ubicacion_id = sisco.ubicacion.id where sisco.solicitud.estatus<>4 and sisco.solicitud.estatus<>3 and tipo='Externa' order by fecha DESC");
    		$query=pg_query($sql);
            $fila=pg_fetch_all($query);
            return $fila;
    	}
        ...
        */
    	function listar_solicitud_alguacil_int(){
    		$sql = ("select date(fecha) as fecha, extract(hour from fecha) as hora, extract(minute from fecha) as minuto, extract(second from fecha) as segundo,nombre, apellido, tipo, numero_expediente, numero_pieza, ubicacion, sisco.solicitud.estatus as estatus, sisco.solicitud.id from sisco.solicitud inner join sisco.usuario on sisco.solicitud.usuario_id = sisco.usuario.id inner join sisco.tipo_solicitud on sisco.solicitud.tipo_solicitud_id = sisco.tipo_solicitud.id inner join sisco.pieza on sisco.solicitud.pieza_id = sisco.pieza.id inner join sisco.expediente on sisco.pieza.expediente_id = sisco.expediente.id inner join sisco.ubicacion on sisco.solicitud.ubicacion_id = sisco.ubicacion.id where sisco.solicitud.estatus=1 or sisco.solicitud.estatus=2");
    		$query=pg_query($sql);
            $fila=pg_fetch_all($query);
            return $fila;
    	}
        ...
        function listar_solicitud_alguacil_ext(){
            $sql = ("select date(fecha) as fecha, extract(hour from fecha) as hora, extract(minute from fecha) as minuto, extract(second from fecha) as segundo,nombre, apellido, tipo, numero_expediente, numero_pieza, ubicacion, sisco.solicitud.estatus as estatus, sisco.solicitud.id from sisco.solicitud inner join sisco.solicitante_externo on sisco.solicitud.usuario_id = sisco.solicitante_externo.id inner join sisco.tipo_solicitud on sisco.solicitud.tipo_solicitud_id = sisco.tipo_solicitud.id inner join sisco.pieza on sisco.solicitud.pieza_id = sisco.pieza.id inner join sisco.expediente on sisco.pieza.expediente_id = sisco.expediente.id inner join sisco.ubicacion on sisco.solicitud.ubicacion_id = sisco.ubicacion.id where sisco.solicitud.estatus=1 or sisco.solicitud.estatus=2");
            $query=pg_query($sql);
            $fila=pg_fetch_all($query);
            return $fila;
        }
        ...
        */
    	function listar_solicitud_jefe($usuario){
    		$sql = ("select fecha, nombre, apellido, tipo, numero_expediente, numero_pieza, ubicacion from sisco.solicitud inner join sisco.usuario on sisco.solicitud.usuario_id = sisco.usuario.id inner join sisco.tipo_solicitud on sisco.solicitud.tipo_solicitud_id = sisco.tipo_solicitud.id inner join sisco.pieza on sisco.solicitud.pieza_id = sisco.pieza.id inner join sisco.expediente on sisco.pieza.expediente_id = sisco.expediente.id inner join sisco.ubicacion on sisco.solicitud.ubicacion_id = sisco.ubicacion.id where sisco.solicitud.estatus<>4 and sisco.solicitud.estatus<>3 or sisco.usuario.id = '$usuario'");
    		$query=pg_query($sql);
            $fila=pg_fetch_all($query);
            return $fila;
    	}
