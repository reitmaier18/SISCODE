<?php
    ...
    if ($data=='Este expediente no existe') {
        ...
        echo "<td><img src='img/icon7.png' id='edit' data-toggle='modal' data-target='#actualizar_expediente' onclick='update_form_expe();'> <img src='img/icon8.png' id='detail' onclick='list_pieza();'></td>";
        echo "</tr>";
    }
